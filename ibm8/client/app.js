(() => {
  ...
  try { globe3d=window.MissionGlobe.createGlobe({canvas:$('earth-webgl'),overlay:$('orbit-overlay'),interaction:canvas,container:$('globe-wrap'),marker:$('iss-marker'),fallback:$('globe-fallback'),reducedMotion:matchMedia('(prefers-reduced-motion: reduce)').matches}); }
